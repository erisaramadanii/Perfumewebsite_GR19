...
class Parfum {
    ...
    public function __construct($emri, $foto, $cmimi, $gjinia) {
        $this->emri = $emri;
        $this->foto = $foto;
        $this->cmimi = $cmimi;
        $this->gjinia = $gjinia;
...
class ParfumFemra extends Parfum {
    public function __construct($emri, $foto, $cmimi) {
        parent::__construct($emri, $foto, $cmimi, "female");
    }
}

class ParfumMeshkuj extends Parfum {
    public function __construct($emri, $foto, $cmimi) {
        parent::__construct($emri, $foto, $cmimi, "male");
    }
}

// Lista e parfumave:
$parfumet = [
    new ParfumFemra("Classique", "F1_Classique.jpg", 55),
    new ParfumFemra("Scandal", "F2_Scandal.jpg", 70),
    new ParfumFemra("La Belle", "F3_La_Belle.webp", 68),
    new ParfumFemra("So Scandal", "F4_So_Scandal.jpg", 78),
    new ParfumMeshkuj("La Male", "M5_La_Male.jpg", 60),
    new ParfumMeshkuj("La Male Le Parfum", "M2_La_Male_Le_Parfum.jpg", 75),
    new ParfumMeshkuj("La Beau", "M3_La_Beau.webp", 65),
    new ParfumMeshkuj("Ultra Male", "M4_Ultra_Male.jpg", 80),
];

// Filtrim & sortim:
$gjinia = $_GET['gjinia'] ?? null;
$sort = $_GET['sort'] ?? null;
